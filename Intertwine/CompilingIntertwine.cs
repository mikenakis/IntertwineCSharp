	...
	public class CompilingIntertwineFactory : IntertwineFactory
	{
		...
		public Intertwine<T> GetIntertwine<T>() where T : class
		{
			...
			SysReflectEmit.ModuleBuilder module_builder;
			{
				...
				SysReflectEmit.AssemblyBuilder assembly_builder = Sys.AppDomain.CurrentDomain.DefineDynamicAssembly( assembly_name, IsSaving ? SysReflectEmit.AssemblyBuilderAccess.RunAndSave : SysReflectEmit.AssemblyBuilderAccess.Run, dir: null );
			...
			return new CompilingIntertwine<T>( factory_of_entwiner, factory_of_untwiner );
		}
		...
		private class CompilingIntertwine : Intertwine
		{
			private readonly EntwinerFactory entwiner_factory;
			private readonly UntwinerFactory untwiner_factory;

			protected CompilingIntertwine( EntwinerFactory entwiner_factory, UntwinerFactory untwiner_factory )
			{
				this.entwiner_factory = entwiner_factory;
				this.untwiner_factory = untwiner_factory;
			}
		...
		{
			public CompilingIntertwine( EntwinerFactory entwiner_factory, UntwinerFactory untwiner_factory )
					: base( entwiner_factory, untwiner_factory )
			{ }
			...
			public T NewEntwiner( AnyCall any_call )
			{
			...
			/// </returns>
			public AnyCall NewUntwiner( T target )
			{
